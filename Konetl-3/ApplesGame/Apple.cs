    ...
    public class Apple
    {
        ...
        private void setAppleGraphics(int colourParam)
        {
            ...
            switch (colourParam)
            {
                ...
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/red_apple.png", UriKind.Relative));
                //    Figure.Background = appleImage;
                //    break;
                ...
                //    appleImage = new ImageBrush();
                //    appleImage.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/green_apple.png", UriKind.Relative));
                //    Figure.Background = appleImage;
                //    break;
                ...
                //    appleImage = new ImageBrush();
                //    appleImage.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/yellow_apple.png", UriKind.Relative));
                //    Figure.Background = appleImage;
                //    break;
                ...
                //    appleImage = new ImageBrush();
                //    appleImage.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/orange_apple.png", UriKind.Relative));
                //    Figure.Background = appleImage;
                //    break;
                ...
                //    appleImage = new ImageBrush();
                //    appleImage.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/brown_apple.png", UriKind.Relative));
                //    Figure.Background = appleImage;
                //    break;
