    ...
    class Basket
    {
        ...
        private void setGraphics(int colourParam)
        {
            ...
            switch (colourParam)
            {
                ...
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/red_basket.png", UriKind.Relative));
                //    Figure.Background = basketBg;
                //    break;
                //case 1:
                //    color = Colors.Green;
                //    basketBg = new ImageBrush();
                //    basketBg.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/green_basket.png", UriKind.Relative));
                //    Figure.Background = basketBg;
                //    break;
                //case 2:
                //    color = Colors.Yellow;
                //    basketBg = new ImageBrush();
                //    basketBg.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/yellow_basket.png", UriKind.Relative));
                //    Figure.Background = basketBg;
                //    break;
                //case 3:
                //    Color = Colors.Orange;
                //    basketBg = new ImageBrush();
                //    basketBg.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/orange_basket.png", UriKind.Relative));
                //    Figure.Background = basketBg;
                //    break;
                //case 4:
                //    Color = Colors.Brown;
                //    basketBg = new ImageBrush();
                //    basketBg.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/brown_basket.png", UriKind.Relative));
                //    Figure.Background = basketBg;
                //    break;
                //default:
                //    color = Colors.Red;
                //    basketBg = new ImageBrush();
                //    basketBg.ImageSource =
                //        new BitmapImage(new Uri(@"../../../ApplesGame/Resources/basket.png", UriKind.Relative));
                //    Figure.Background = basketBg;
                //    break;
            }
        }
